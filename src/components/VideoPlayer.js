...
class VideoPlayer extends Component         {
        ...
        changeSize()                        {
            var vd = document.getElementById('video');
            var moz = document.getElementById('centerDiv');
            ...
            //from Normal Screen to Full
                ...
                this.props.dispatch(toggleFullScreen(true));
                    ...
                    //menu.mozRequestFullscreen();
                    this.props.dispatch(toggleFullScreen(true));
                                                    }
                else if (moz.msRequestFullscreen)    {
                    moz.msRequestFullscreen();
                    //menu.msRequestFullscreen();
                    this.props.dispatch(toggleFullScreen(true));
                                                    }
